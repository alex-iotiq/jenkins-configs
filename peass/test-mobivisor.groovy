...
//                     sh 'git edit-peass HEAD~3 "${JENKINS_HOME}/peass_scripts/build.gradle" "${WORKSPACE}/app"'
        ...
        stage('performance test') {
            ...
            steps {
              measure VMs: 2, createDefaultConstructor: false, generateCoverageSelection: true, iterations: 2, measurementMode: 'COMPLETE', nightlyBuild: false, redirectSubprocessOutputToFile: false, redirectToNull: false, repetitions: 2, testGoal: 'testBorDebugUnitTest', timeout: 10, updateSnapshotDependencies: false, useSourceInstrumentation: false, versionDiff: 5
            }
        }
    }
}
