...
//                     sh 'git edit-peass HEAD~3 "${JENKINS_HOME}/peass_scripts/build.gradle" "${WORKSPACE}/app"'
        ...
        stage('performance test') {
            ...
            steps {
              measure VMs: 2, createDefaultConstructor: false, iterations: 1, measurementMode: 'COMPLETE', nightlyBuild: false, redirectSubprocessOutputToFile: false, redirectToNull: false, repetitions: 2, testGoal: 'testBorDebugUnitTest', timeout: 30, updateSnapshotDependencies: false, useAggregation: false, useSourceInstrumentation: false
            }
        }
    }
}
