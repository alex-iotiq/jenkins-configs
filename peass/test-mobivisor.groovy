...
//                     sh 'git edit-peass HEAD~3 "${JENKINS_HOME}/peass_scripts/build.gradle" "${WORKSPACE}/app"'
        ...
        stage('performance test') {
            ...
            steps {
              measure VMs: 2, generateCoverageSelection: true, createDefaultConstructor: true, iterations: 1, measurementMode: 'COMPLETE', repetitions: 1, testGoal: 'testBorDebugUnitTest', timeout: 10, updateSnapshotDependencies: false, useSampling: false, useSourceInstrumentation: false, warmup: 1, displayLogs: 'true', displayRCALogs: 'true', displayRTSLogs: 'true', redirectToNull: false
            }
        }
    }
}
